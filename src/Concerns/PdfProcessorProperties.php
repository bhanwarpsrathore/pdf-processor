...
namespace Bhanwarpsrathore\PdfProcessor\Concerns;

use Bhanwarpsrathore\PdfProcessor\Attributes\Option;
use Bhanwarpsrathore\PdfProcessor\Enums\AutoRotatePages;
use Bhanwarpsrathore\PdfProcessor\Enums\ColorConversionStrategy;
use Bhanwarpsrathore\PdfProcessor\Enums\ImageDepth;
use Bhanwarpsrathore\PdfProcessor\Enums\ColorImageDownSampleType;
use Bhanwarpsrathore\PdfProcessor\Enums\ImageFilter;
use Bhanwarpsrathore\PdfProcessor\Enums\CompatibilityLevel;
use Bhanwarpsrathore\PdfProcessor\Enums\DefaultRenderingIntent;
use Bhanwarpsrathore\PdfProcessor\Enums\GrayImageDownSampleType;
use Bhanwarpsrathore\PdfProcessor\Enums\MonoImageDownSampleType;
use Bhanwarpsrathore\PdfProcessor\Enums\MonoImageFilter;
use Bhanwarpsrathore\PdfProcessor\Enums\PdfSettings;
use Bhanwarpsrathore\PdfProcessor\Enums\ProcessColorModel;
use Bhanwarpsrathore\PdfProcessor\Enums\UCRandBGInfo;
use Bhanwarpsrathore\PdfProcessor\PdfProcessor;

trait PdfProcessorProperties {
    /**
     * @var string[]
     */
